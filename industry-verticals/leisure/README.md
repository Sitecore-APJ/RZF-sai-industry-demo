# Leisure - Mandai Wildlife Reserve
...
6. Install dependencies:
   from `industry-verticals/leisure` run `npm install`
...
6. Provide Editing host name `leisure` as per xmcloud.build.json
